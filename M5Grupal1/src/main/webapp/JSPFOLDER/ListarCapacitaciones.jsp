...
<%@ page import="patronDAO.Capacitacion"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td><%=capacitacion.getNombreUsuario()%></td>
					<td>
						<div class="button-container">
							<form action="./SrvListarCapacitaciones" method="POST">
								<input type="hidden" name="idEliminar"
									value="<%=capacitacion.getId()%>">
								<button type="submit" class="btn btn-danger">Eliminar</button>
							</form>
							<form action="./ServletEditarCapacitaciones" method="GET">
