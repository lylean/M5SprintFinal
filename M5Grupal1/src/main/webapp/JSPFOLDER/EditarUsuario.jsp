			...
			<table class="table">
				...
				<tbody>
					<tr>
						...
						<td><select class="form-control form-control-sm" name="tipo"
							id="tipo">
								<option disabled value="">Selecciona tu tipo de perfil</option>
								<%String tipo = (String) request.getAttribute("tipo");%>
								<%String[] tipos = { "Administrativo", "Profesional", "Cliente" };%>
								<%for (String t : tipos) {%>
								<%if (t.equals(tipo)) {%>
